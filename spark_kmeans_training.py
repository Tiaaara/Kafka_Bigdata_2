...
# Function to train and save KMeans model and calculate silhouette score
def train_and_save_kmeans_model(data, model_number, model_type, k=3):
    ...
    print(f"Silhouette Score for {model_type} model {model_number}: {silhouette_score}")
...
# Train models for each batch file and calculate Silhouette Score
